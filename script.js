...
function iniciarGame(){
    ...
    if(snake[0].x > 15 * box && direction == "right") gameOver();
    if(snake[0].x < 0 && direction == "left") gameOver();
    if(snake[0].y > 15 * box && direction == "down") gameOver();
    ...
    //troca a posição da food se a snake comer    
